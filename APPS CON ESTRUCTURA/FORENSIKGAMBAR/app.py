...
- {technical_details.get('methodology', 'Analisis fusi multi-modal')}
- Reliabilitas: {technical_details.get('reliability_rating', 'Tinggi')}
...
- **Metode Deteksi:** Analisis fusi multi-lapisan
...
""")
    ...
    with col6:
        st.subheader("TruFor: Analisis Forensik", divider='rainbow')
        ...
        if trufor_results and 'error' not in trufor_results:
            ...
            with st.expander("Detail Teknis TruFor", expanded=False):
                ...
                st.markdown(f"""
**Metodologi TruFor:**
- {technical_details.get('methodology', 'Analisis forensik multi-skala')}
- Reliabilitas: {technical_details.get('reliability_rating', 'Sangat Tinggi')}
- Kedalaman analisis: {technical_details.get('analysis_depth', 'Mendalam')}
...
""")
    ...
    with col5:
        ...
        if isinstance(jpeg_ghost_display, np.ndarray) and jpeg_ghost_display.size > 0:
            ...
            ax1.text(0.5, 0.5, 'Peta Ghost Tidak Tersedia',
...
def main_app():
    ...
    try:
        ...
        with col2:
            # Path yang benar ke logo UHO
            logo_path = "asset/Logo-UHO-Normal.png"
            if os.path.exists(logo_path):
                st.image(logo_path, width=100)
            else:
                # Fallback jika logo tidak ditemukan
                st.markdown("<div style='font-size: 3em; margin: 10px 0;'>🏛️</div>", unsafe_allow_html=True)
    except Exception as e:
        # Fallback dengan emoji jika ada error
...
# Tombol Keluar (tidak ada perubahan pada logika ini)
    ...
    # Footer sidebar dengan informasi lengkap
    st.sidebar.markdown("---")
    st.sidebar.info("""
    **foreinsight Image v2.0**
    
    Sistem deteksi manipulasi gambar digital menggunakan:
    • Pipeline 19 tahap analisis
    • Multi-algoritma forensik
    ...
    <div style='text-align: center; margin-top: 20px; padding: 10px; 
        ...
        <p style='margin: 0; color: white; font-size: 0.8em;'>
            © 2025 Universitas Halu Oleo<br>
            Fakultas Teknik<br>
            <strong>Developed by: Agrian Wahab</strong>
        </p>
    </div>
    """, unsafe_allow_html=True)

    # Header utama dengan logo UHO
    # Membuat 3 kolom untuk layout header
    ...
    with header_col2:
        ...
        with text_col:
            ...
            <div style='margin-top: 10px;'>
                <p style='margin: 0; color: #1e3a8a; font-size: 1.1em; font-weight: 600;'>
                    Universitas Halu Oleo
                </p>
                <p style='margin: 0; color: #475569; font-size: 0.9em;'>
                    Fakultas Teknik - Program Studi Teknik Informatika
                </p>
                <h2 style='margin: 5px 0; color: #334155; font-weight: 500; font-size: 1.3em;'>
                    Sistem Deteksi Manipulasi Gambar Digital
                </h2>
            </div>
            """, unsafe_allow_html=True)
    ...
    # Divider line
    st.markdown("""
    <div style='width: 80%; height: 2px; background: linear-gradient(90deg, #1e3a8a, #3b82f6, #06b6d4); 
                margin: 20px auto 30px auto; border-radius: 2px;'></div>
    """, unsafe_allow_html=True)
    ...
    if st.session_state.analysis_results:
        ...
        with tab6:
            ...
            export_format = st.selectbox(
                ...
                options=["-", "Laporan DOCX", "Visualisasi PNG", "Paket Lengkap (.zip)"],
